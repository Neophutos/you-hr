package com.example.application.views.adressformular;
...
@PageTitle("Adressformular")
@Route(value = "adressformular", layout = MainLayout.class)
@RolesAllowed("USER")
public class AdressformularView extends Div {
    ...
    public AdressformularView(SampleAddressService addressService) {
        addClassName("adressformular-view");
